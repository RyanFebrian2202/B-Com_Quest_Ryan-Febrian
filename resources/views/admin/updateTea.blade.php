    ...
    <div class="container">
        <div class="row">
            ...
            <div class="form-bg col-md-6 p-4 rounded-3">
                <h1 style="font-weight: bold; display: flex; justify-content: center; align-self: center">Update Tea
                </h1>
                <br>

                <form action="{{route('updateTea', ['id'=> $tea->id])}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('patch')
